PROTO_0:
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K1 ["DisplayVoiceBetaBadge"]
  ORK R0 R1 K0 [False]
  RETURN R0 1

PROTO_1:
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K1 ["ShowBadgeOver12"]
  ORK R0 R1 K0 [False]
  RETURN R0 1

PROTO_2:
  DUPTABLE R1 K2 [{"getDisplayVoiceBetaBadge", "showBadgeOver12"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  SETTABLEKS R2 R1 K0 ["getDisplayVoiceBetaBadge"]
  NEWCLOSURE R2 P1
  CAPTURE VAL R0
  SETTABLEKS R2 R1 K1 ["showBadgeOver12"]
  RETURN R1 1
