PROTO_0:
  ...
  GETTABLEN R1 R2 1
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K1 ["fromGetExperienceInfo"]
  MOVE R3 R1
  CALL R2 1 1
  GETUPVAL R3 1
  GETUPVAL R5 2
  ...
  GETUPVAL R5 3
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K3 ["Counters"]
  GETTABLEKS R7 R9 K4 ["GetExperienceInfo"]
  GETUPVAL R10 4
  GETTABLEKS R9 R10 K5 ["CounterSuffix"]
  GETTABLEKS R8 R9 K6 ["RequestSucceeded"]
  CONCAT R6 R7 R8
  CALL R5 1 -1
  NAMECALL R3 R3 K2 ["dispatch"]
  CALL R3 -1 0
...
PROTO_1:
  ...
  GETTABLEKS R5 R7 K1 ["GetExperienceInfo"]
  GETUPVAL R8 2
...
PROTO_2:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["getExperienceInfo"]
  GETUPVAL R1 1
  CALL R0 1 1
  NEWCLOSURE R2 P0
  CAPTURE UPVAL U2
...
MAIN:
  ...
  SETLIST R10 R11 1 [1]
  MOVE R11 R5
  LOADK R12 K24 ["getExperienceInfo"]
  CALL R11 1 1
