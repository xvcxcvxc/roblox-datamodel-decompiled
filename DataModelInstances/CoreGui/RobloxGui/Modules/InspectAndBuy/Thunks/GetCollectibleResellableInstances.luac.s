PROTO_0:
  MOVE R1 R0
  JUMPIFNOT R1 [+2]
  GETTABLEKS R1 R0 K0 ["itemInstances"]
  JUMPIFNOT R1 [+8]
  GETUPVAL R2 0
  GETUPVAL R4 1
  GETUPVAL R5 2
  ...
  GETUPVAL R4 3
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K2 ["Counters"]
  GETTABLEKS R6 R8 K3 ["GetCollectibleResellableInstances"]
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K4 ["CounterSuffix"]
  GETTABLEKS R7 R8 K5 ["RequestSucceeded"]
  CONCAT R5 R6 R7
  CALL R4 1 -1
  NAMECALL R2 R2 K1 ["dispatch"]
  CALL R2 -1 0
  ...
  GETUPVAL R4 3
  GETUPVAL R7 4
  GETTABLEKS R6 R7 K2 ["Counters"]
  GETTABLEKS R5 R6 K6 ["GetCollectibleResellableInstancesRequestSucceededWithoutResult"]
  CALL R4 1 -1
  NAMECALL R2 R2 K1 ["dispatch"]
  CALL R2 -1 0
  RETURN R0 0
...
PROTO_1:
  ...
  GETTABLEKS R5 R7 K1 ["GetCollectibleResellableInstances"]
  GETUPVAL R8 2
...
PROTO_2:
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["getCollectibleResellableInstances"]
  GETUPVAL R1 1
  GETUPVAL R2 2
  CALL R0 2 1
  NEWCLOSURE R2 P0
...
MAIN:
  ...
  GETTABLEKS R6 R7 K17 ["SetCollectibleResellableInstances"]
  CALL R5 1 1
  ...
  SETLIST R9 R10 1 [1]
  MOVE R10 R6
  LOADK R11 K22 ["getCollectibleResellableInstances"]
  CALL R10 1 1
