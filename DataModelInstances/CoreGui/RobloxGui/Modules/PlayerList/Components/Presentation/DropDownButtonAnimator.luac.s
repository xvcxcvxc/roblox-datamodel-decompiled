...
PROTO_8:
  ...
  GETTABLEKS R2 R3 K0 ["createElement"]
  LOADK R3 K1 ["Frame"]
  DUPTABLE R4 K21 [{"ZIndex", "Size", "BackgroundTransparency", "LayoutOrder"}]
  LOADN R5 2
  SETTABLEKS R5 R4 K19 ["ZIndex"]
  GETIMPORT R5 K8 [UDim2.new]
  LOADN R6 1
  LOADN R7 0
  LOADN R8 0
  GETTABLEKS R9 R0 K22 ["DropDownButtonSizeY"]
  CALL R5 4 1
  SETTABLEKS R5 R4 K2 ["Size"]
  LOADN R5 1
  SETTABLEKS R5 R4 K4 ["BackgroundTransparency"]
  ...
  GETTABLEKS R5 R6 K23 ["layoutOrder"]
  SETTABLEKS R5 R4 K20 ["LayoutOrder"]
  MOVE R5 R1
  CALL R2 3 -1
  RETURN R2 -1
...
MAIN:
  ...
  DUPTABLE R13 K33 [{"text", "icon", "lastButton", "layoutOrder", "onActivated", "forceShowOptions", "selectedPlayer", "onDecline", "onDismiss"}]
  GETTABLEKS R14 R2 K34 ["string"]
  SETTABLEKS R14 R13 K24 ["text"]
  GETTABLEKS R14 R2 K35 ["union"]
  GETTABLEKS R15 R2 K34 ["string"]
  GETTABLEKS R16 R2 K36 ["table"]
  CALL R14 2 1
  SETTABLEKS R14 R13 K25 ["icon"]
  GETTABLEKS R14 R2 K37 ["boolean"]
  SETTABLEKS R14 R13 K26 ["lastButton"]
  GETTABLEKS R14 R2 K38 ["integer"]
  ...
  GETTABLEKS R14 R2 K40 ["optional"]
  GETTABLEKS R15 R2 K41 ["instanceIsA"]
  LOADK R16 K42 ["Player"]
  CALL R15 1 -1
  CALL R14 -1 1
  SETTABLEKS R14 R13 K30 ["selectedPlayer"]
  GETTABLEKS R14 R2 K40 ["optional"]
  GETTABLEKS R15 R2 K39 ["callback"]
  CALL R14 1 1
  ...
  CAPTURE VAL R3
  CAPTURE VAL R9
  SETTABLEKS R12 R11 K45 ["init"]
  DUPCLOSURE R12 K46 [PROTO_7]
  SETTABLEKS R12 R11 K47 ["getButtonProps"]
  DUPCLOSURE R12 K48 [PROTO_9]
  CAPTURE VAL R7
  CAPTURE VAL R1
  CAPTURE VAL R8
  SETTABLEKS R12 R11 K49 ["render"]
  DUPCLOSURE R12 K50 [PROTO_10]
  CAPTURE VAL R3
  CAPTURE VAL R10
  CAPTURE VAL R1
  SETTABLEKS R12 R11 K51 ["didUpdate"]
  DUPCLOSURE R12 K52 [PROTO_11]
  SETTABLEKS R12 R11 K53 ["willUnmount"]
  RETURN R11 1
