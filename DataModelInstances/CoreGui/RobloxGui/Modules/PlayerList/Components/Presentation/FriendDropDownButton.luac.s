...
PROTO_6:
  ...
  GETUPVAL R9 4
  DUPTABLE R10 K21 [{"layoutOrder", "text", "icon", "lastButton", "onActivated", "forceShowOptions", "selectedPlayer", "onDecline", "onDismiss"}]
...
MAIN:
  ...
  DUPTABLE R14 K34 [{"layoutOrder", "playerRelationship", "selectedPlayer", "dropDownOpen", "requestFriendship"}]
  GETTABLEKS R15 R5 K35 ["integer"]
  SETTABLEKS R15 R14 K29 ["layoutOrder"]
  GETTABLEKS R15 R5 K28 ["strictInterface"]
  DUPTABLE R16 K40 [{"isBlocked", "friendStatus", "isFollowing", "isFollower"}]
  GETTABLEKS R17 R5 K41 ["boolean"]
  SETTABLEKS R17 R16 K36 ["isBlocked"]
  GETTABLEKS R17 R5 K42 ["enum"]
  GETIMPORT R18 K45 [Enum.FriendStatus]
  CALL R17 1 1
  SETTABLEKS R17 R16 K37 ["friendStatus"]
  GETTABLEKS R17 R5 K41 ["boolean"]
  SETTABLEKS R17 R16 K38 ["isFollowing"]
  GETTABLEKS R17 R5 K41 ["boolean"]
  SETTABLEKS R17 R16 K39 ["isFollower"]
  CALL R15 1 1
  SETTABLEKS R15 R14 K30 ["playerRelationship"]
  GETTABLEKS R15 R5 K46 ["optional"]
  GETTABLEKS R16 R5 K47 ["instanceIsA"]
  LOADK R17 K48 ["Player"]
  CALL R16 1 -1
  CALL R15 -1 1
  SETTABLEKS R15 R14 K31 ["selectedPlayer"]
  GETTABLEKS R15 R5 K41 ["boolean"]
  SETTABLEKS R15 R14 K32 ["dropDownOpen"]
  GETTABLEKS R15 R5 K49 ["callback"]
  SETTABLEKS R15 R14 K33 ["requestFriendship"]
  CALL R13 1 1
  SETTABLEKS R13 R12 K50 ["validateProps"]
  DUPCLOSURE R13 K51 [PROTO_0]
  CAPTURE VAL R8
  CAPTURE VAL R10
  DUPCLOSURE R14 K52 [PROTO_1]
  SETTABLEKS R14 R12 K53 ["init"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R7
  SETTABLEKS R14 R12 K55 ["render"]
  DUPCLOSURE R14 K56 [PROTO_7]
  SETTABLEKS R14 R12 K57 ["didUpdate"]
  RETURN R12 1
