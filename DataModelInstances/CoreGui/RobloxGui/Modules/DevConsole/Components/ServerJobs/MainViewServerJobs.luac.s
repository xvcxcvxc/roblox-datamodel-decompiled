...
PROTO_1:
  ...
  GETTABLEKS R1 R2 K1 ["dispatchServerJobsUpdateSearchFilter"]
  MOVE R2 R0
  NEWTABLE R3 0 0
  CALL R1 2 0
  RETURN R0 0
...
PROTO_5:
  ...
  GETTABLEKS R4 R5 K4 ["jobsSearchTerm"]
  ...
  DUPTABLE R9 K19 [{"UIListLayout", "UtilAndTab", "ServerJobs"}]
  GETUPVAL R11 0
  ...
  SETTABLEKS R13 R12 K30 ["layoutOrder"]
  CALL R10 2 1
  SETTABLEKS R10 R9 K18 ["ServerJobs"]
  CALL R6 3 -1
  RETURN R6 -1

PROTO_6:
  DUPTABLE R2 K1 [{"jobsSearchTerm"}]
  GETTABLEKS R4 R0 K2 ["ServerJobsData"]
  GETTABLEKS R3 R4 K0 ["jobsSearchTerm"]
...
PROTO_8:
  DUPTABLE R1 K1 [{"dispatchServerJobsUpdateSearchFilter"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  SETTABLEKS R2 R1 K0 ["dispatchServerJobsUpdateSearchFilter"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R6 R3 K13 ["ServerJobs"]
  GETTABLEKS R5 R6 K14 ["ServerJobsChart"]
  CALL R4 1 1
  ...
  GETTABLEKS R8 R6 K17 ["ServerJobsUpdateSearchFilter"]
  CALL R7 1 1
  ...
  LOADK R12 K22 ["MainViewServerJobs"]
