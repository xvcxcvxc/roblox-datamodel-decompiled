...
PROTO_1:
  ...
  GETTABLEKS R3 R4 K1 ["dispatchServerScriptsUpdateSearchFilter"]
  LOADNIL R4
  MOVE R5 R2
  CALL R3 2 0
  RETURN R0 0
...
PROTO_2:
  ...
  GETTABLEKS R1 R2 K1 ["dispatchServerScriptsUpdateSearchFilter"]
  MOVE R2 R0
  NEWTABLE R3 0 0
  CALL R1 2 0
  RETURN R0 0
...
PROTO_3:
  ...
  DUPTABLE R1 K7 [{"utilTabHeight", "isClientView"}]
  LOADN R2 0
  SETTABLEKS R2 R1 K5 ["utilTabHeight"]
  LOADB R2 1
  SETTABLEKS R2 R1 K6 ["isClientView"]
...
PROTO_6:
  ...
  GETTABLEKS R4 R5 K4 ["serverTypeFilters"]
  GETTABLEKS R6 R0 K5 ["state"]
  GETTABLEKS R5 R6 K6 ["utilTabHeight"]
  GETTABLEKS R7 R0 K0 ["props"]
  GETTABLEKS R6 R7 K7 ["serverSearchTerm"]
  NEWTABLE R7 0 0
  ...
  DUPTABLE R11 K24 [{"UIListLayout", "UtilAndTab", "ServerScripts"}]
  GETUPVAL R13 1
  ...
  SETTABLEKS R6 R14 K35 ["searchTerm"]
  LOADN R15 1
  ...
  LOADB R12 0
  LOADN R13 0
  JUMPIFNOTLT R13 R5 [+23]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K12 ["createElement"]
  GETUPVAL R13 5
  DUPTABLE R14 K47 [{"size", "searchTerm", "scriptFilters", "layoutOrder"}]
  ...
  SETTABLEKS R6 R14 K35 ["searchTerm"]
  SETTABLEKS R4 R14 K46 ["scriptFilters"]
  LOADN R15 2
  SETTABLEKS R15 R14 K36 ["layoutOrder"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K23 ["ServerScripts"]
  CALL R8 3 -1
  RETURN R8 -1

PROTO_7:
  DUPTABLE R2 K2 [{"serverSearchTerm", "serverTypeFilters"}]
  GETTABLEKS R4 R0 K3 ["ScriptsData"]
  GETTABLEKS R3 R4 K0 ["serverSearchTerm"]
  SETTABLEKS R3 R2 K0 ["serverSearchTerm"]
  GETTABLEKS R4 R0 K3 ["ScriptsData"]
  GETTABLEKS R3 R4 K1 ["serverTypeFilters"]
...
PROTO_9:
  DUPTABLE R1 K1 [{"dispatchServerScriptsUpdateSearchFilter"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  SETTABLEKS R2 R1 K0 ["dispatchServerScriptsUpdateSearchFilter"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R6 R3 K13 ["Scripts"]
  GETTABLEKS R5 R6 K14 ["ServerScripts"]
  CALL R4 1 1
  ...
  GETTABLEKS R8 R6 K17 ["ServerScriptsUpdateSearchFilter"]
  CALL R7 1 1
  ...
  NEWTABLE R10 0 2
  LOADK R11 K21 ["Active"]
  LOADK R12 K22 ["Inactive"]
  SETLIST R10 R11 2 [1]
  GETTABLEKS R11 R1 K23 ["PureComponent"]
  LOADK R13 K24 ["MainViewScripts"]
  ...
  SETTABLEKS R12 R11 K31 ["didUpdate"]
  ...
  CAPTURE VAL R7
  GETTABLEKS R14 R2 K36 ["UNSTABLE_connect2"]
  MOVE R15 R12
  MOVE R16 R13
  CALL R14 2 1
  MOVE R15 R11
