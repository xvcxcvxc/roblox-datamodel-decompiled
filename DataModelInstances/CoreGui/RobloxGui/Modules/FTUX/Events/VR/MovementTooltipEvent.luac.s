PROTO_0:
  ...
  DUPTABLE R5 K6 [{"Text", "Controller", "ButtonKeycode"}]
  LOADK R6 K15 ["Move"]
  SETTABLEKS R6 R5 K3 ["Text"]
  GETIMPORT R6 K17 [Enum.UserCFrame.LeftHand]
  SETTABLEKS R6 R5 K4 ["Controller"]
  GETIMPORT R6 K19 [Enum.KeyCode.ButtonL3]
  SETTABLEKS R6 R5 K5 ["ButtonKeycode"]
  DUPTABLE R6 K6 [{"Text", "Controller", "ButtonKeycode"}]
  LOADK R7 K20 ["Jump"]
  SETTABLEKS R7 R6 K3 ["Text"]
  GETIMPORT R7 K11 [Enum.UserCFrame.RightHand]
  SETTABLEKS R7 R6 K4 ["Controller"]
  GETIMPORT R7 K22 [Enum.KeyCode.ButtonA]
  SETTABLEKS R7 R6 K5 ["ButtonKeycode"]
  SETLIST R3 R4 3 [1]
  ...
  CALL R1 1 1
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K23 ["mount"]
  MOVE R3 R1
  GETUPVAL R4 4
  LOADK R6 K24 ["FTUXMenu"]
  NAMECALL R4 R4 K25 ["FindFirstChild"]
  CALL R4 2 1
  LOADK R5 K26 ["MovementTooltip"]
  CALL R2 3 1
  SETUPVAL R2 3
  RETURN R0 0
...
MAIN:
  ...
  LOADK R7 K20 ["MovementTooltipEvent"]
