PROTO_0:
  ...
  LOADK R2 K2 ["EnableNewInviteMenuCustomization2"]
  NAMECALL R0 R0 K3 ["GetFastFlag"]
  CALL R0 2 1
  JUMPIF R0 [+13]
  GETIMPORT R0 K1 [game]
  LOADK R2 K4 ["EnableNewInviteMenuCustomizationIXP2"]
  NAMECALL R0 R0 K3 ["GetFastFlag"]
  CALL R0 2 1
  JUMPIFNOT R0 [+6]
  GETUPVAL R1 0
...
MAIN:
  ...
  LOADK R6 K13 ["EnableNewInviteMenuCustomization2"]
  LOADB R7 0
  NAMECALL R4 R4 K14 ["DefineFastFlag"]
  CALL R4 3 0
  GETIMPORT R4 K1 [game]
  LOADK R6 K15 ["EnableNewInviteMenuCustomizationIXP2"]
  LOADB R7 0
  NAMECALL R4 R4 K14 ["DefineFastFlag"]
  CALL R4 3 0
