...
PROTO_8:
  ...
  GETUPVAL R7 1
  DUPTABLE R8 K27 [{"backgroundTransparency", "barHeight", "margin", "renderLeft", "renderRight", "title", "renderCenter", "isSecondary"}]
  LOADN R9 1
  ...
  GETTABLEKS R10 R0 K28 ["backAction"]
  ...
  GETTABLEKS R11 R0 K30 ["undoAnnotationPoints"]
  GETTABLEKS R12 R0 K31 ["redoAnnotationPoints"]
  ...
  LOADNIL R9
  JUMP [+2]
  GETTABLEKS R9 R0 K33 ["titleText"]
  SETTABLEKS R9 R8 K24 ["title"]
  GETUPVAL R10 5
  CALL R10 0 1
  JUMPIFNOT R10 [+7]
  GETTABLEKS R10 R0 K33 ["titleText"]
  NEWCLOSURE R9 P3
  CAPTURE UPVAL U6
  CAPTURE UPVAL U0
  CAPTURE VAL R10
  JUMP [+1]
  LOADNIL R9
  SETTABLEKS R9 R8 K25 ["renderCenter"]
  LOADB R9 1
  SETTABLEKS R9 R8 K26 ["isSecondary"]
  CALL R6 2 1
...
MAIN:
  ...
  GETTABLEKS R6 R3 K12 ["Flags"]
  GETTABLEKS R5 R6 K13 ["GetFFlagReportAnythingLocalizationEnabled"]
  CALL R4 1 1
  GETTABLEKS R7 R1 K14 ["App"]
  GETTABLEKS R6 R7 K15 ["Bar"]
  GETTABLEKS R5 R6 K16 ["HeaderBar"]
  GETTABLEKS R8 R1 K14 ["App"]
  GETTABLEKS R7 R8 K17 ["Button"]
  GETTABLEKS R6 R7 K18 ["IconButton"]
  GETTABLEKS R10 R1 K14 ["App"]
  GETTABLEKS R9 R10 K19 ["ImageSet"]
  GETTABLEKS R8 R9 K20 ["Enum"]
  GETTABLEKS R7 R8 K21 ["IconSize"]
  GETTABLEKS R10 R1 K14 ["App"]
  GETTABLEKS R9 R10 K19 ["ImageSet"]
  GETTABLEKS R8 R9 K22 ["Images"]
  GETTABLEKS R10 R1 K23 ["Style"]
  GETTABLEKS R9 R10 K24 ["withStyle"]
